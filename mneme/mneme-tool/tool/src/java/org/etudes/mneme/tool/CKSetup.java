			...
			SessionManager.getCurrentSession().setAttribute(attrb, new SecurityAdvisor()
			{
				public SecurityAdvice isAllowed(String userId, String function, String reference)
				{
					try
					{
						...
						Collection<?> mnemeGrpAllowGrade = authzGroupService.getAuthzGroupsIsAllowed(userId,
								org.etudes.mneme.api.MnemeService.GRADE_PERMISSION, null);
						Collection<?> mnemeGrpAllowSubmit = authzGroupService.getAuthzGroupsIsAllowed(userId,
